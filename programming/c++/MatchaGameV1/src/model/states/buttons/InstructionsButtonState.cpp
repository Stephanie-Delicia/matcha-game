...
void InstructionsButtonState::handleInput(Sprite* sprite, const SDL_Event &input) {
...
void InstructionsButtonState::update(Sprite* sprite) {
...
void InstructionsButtonState::draw(Sprite* sprite, SDL_Surface* windowSrfc) {
